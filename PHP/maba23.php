    ...
    <div class="d-flex row ">
        ...
        <div class="col-12 col-md-6 wrapper">
            <form action="" method="post">
                <h1>FORMULIR PENDATAAN MAHASISWA BARU SISTEM INFORMASI ANGKATAN 2023</h1>
                ...
                <input class="mt-3" type="checkbox"> Saya bertanggung jawab atas data yang telah saya berikan.

                <button type="submit" class="btn button_submit mt-3" name="submit">Submit</button>

                <h2 class="text-center mt-4">Follow Us:</h2>
                <div class="d-flex justify-content-center align-items-center">
                    <div class="sosmed d-flex">
                        <div class="bulat d-flex justify-content-center align-items-center me-3">
                        ...
                        <div class="bulat d-flex justify-content-center align-items-center">
                            <a href="www.instagram.com" target=" _blank"><i
